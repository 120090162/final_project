...
from dream.rsl_rl.algorithms import PPO
from dream.rsl_rl.env import VecEnv
from dream.rsl_rl.modules import (
    ActorCritic,
    ActorCriticCNN,
...
from dream.rsl_rl.storage import RolloutStorage
from dream.rsl_rl.utils import resolve_obs_groups
from dream.rsl_rl.utils.logger import Logger
...
class OnPolicyRunner:
    ...
    def _construct_algorithm(self, obs: TensorDict) -> PPO:
        ...
        actor_critic: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCritic_DWAQ = actor_critic_class(
