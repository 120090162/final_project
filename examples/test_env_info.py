...
class RegistryTest(absltest.TestCase):
  ...
  def test_new_env(self):
    ...
    print("Registered environments:", dm_control_suite.ALL_ENVS)
    ...
    print("Registered environments:", manipulation.ALL_ENVS)
    ...
    print("Registered environments:", locomotion.ALL_ENVS)

    print("All registered environments:", registry.ALL_ENVS)
